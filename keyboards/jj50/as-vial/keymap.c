...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ADJUST] = LAYOUT(
        ...
        _______, QK_BOOT, _______, _______, _______, _______, _______, _______, _______, RGB_VAD, RGB_VAI, KC_DEL,
        KC_CAPS, _______, _______, _______, _______, _______, _______, _______, _______, RGB_SAD, RGB_SAI, _______,
